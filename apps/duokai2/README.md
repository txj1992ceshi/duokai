...
- `Duokai2-0.1.0-test.3.1-arm64.dmg`
- `Duokai2-0.1.0-test.3.1-arm64-mac.zip`
...
2. 下载：`Duokai2 Setup 0.1.0-test.3.1.exe`
3. 双击安装
...
- `Duokai2 Setup 0.1.0-test.3.1.exe` 或等价 `NSIS` 安装器
- `Duokai2-0.1.0-test.3.1-win.zip` 便携包
...
- 例如 package 版本是 `0.1.0-test.3.1`，则 release tag 会自动使用 `v0.1.0-test.3.1`
...
- Windows：GitHub `Releases` 中的 `Duokai2 Setup 0.1.0-test.3.1.exe` 和 `Duokai2-0.1.0-test.3.1-win.zip`
