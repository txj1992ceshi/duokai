...
> = {
  'zh-CN': {
    ...
    conflict: '环境同步冲突',
    conflictDetail: '云端环境配置已更新，请选择上传本地改动或从云端拉取',
    error: '环境同步失败',
    pending: '环境待同步',
    pendingDetail: '本地环境配置有改动尚未上传到云端',
    syncing: '环境同步中',
    syncingDetail: '正在同步环境配置到云端',
    synced: '环境已同步',
    idle: '环境未同步',
    idleDetail: '当前环境尚未执行过环境同步',
  },
  'en-US': {
    syncedAt: 'Last sync',
    ...
    conflictDetail: 'Cloud environment config changed. Upload local changes or pull from cloud.',
    error: 'Environment sync failed',
    pending: 'Environment pending',
    pendingDetail: 'Local environment changes are waiting to be uploaded',
    syncing: 'Environment syncing',
    syncingDetail: 'Syncing environment config',
    synced: 'Environment synced',
    idle: 'Environment not synced',
    idleDetail: 'No environment sync has been completed for this environment yet',
  },
}
