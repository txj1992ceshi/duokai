...
import platformPoliciesRouter from './routes/platformPolicies.js';
import proxyAssetsRouter from './routes/proxyAssets.js';
import ipLeasesRouter from './routes/ipLeases.js';
...
app.use('/api/platform-policies', platformPoliciesRouter);
app.use('/api/proxy-assets', proxyAssetsRouter);
app.use('/api/ip-leases', ipLeasesRouter);
